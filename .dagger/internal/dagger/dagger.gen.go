...
func (r *Query) LoadBackendFromID(id BackendID) *Backend {
...
func (r *Query) LoadFrontendFromID(id FrontendID) *Frontend {
...
func (r *Query) LoadHelmPackageFromID(id HelmPackageID) *HelmPackage {
...
func (r *Query) LoadHelmReleaseFromID(id HelmReleaseID) *HelmRelease {
